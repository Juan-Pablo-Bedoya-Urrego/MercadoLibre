...
import CategoriesTelevisionScreen from './CategoriesTelevisionScreen';/*
...
const ItemsCategoriesScreen = ({ navigation }) => {
    return (
        <View style={itemsCategoriesStyles.container}>
            <View style={itemsCategoriesStyles.buttonContainer}>
                <Button
                    ...
                    title="Television"
                    onPress={() => navigation.navigate('CategoriesTelevisionScreen')}
                />
            </View>
            <View style={itemsCategoriesStyles.buttonContainer}>
                <Button
...
export default ItemsCategoriesScreen;