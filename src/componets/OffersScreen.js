...
const OffersScreen = () => {
    ...
    const theOffers = () => {
        const offersList = [
            ...
            { id: '5', title: 'Sony Alpha A7 III', description: 'Cámara sin espejo con sensor full-frame de 24.2 MP, grabación de video 4K,.', worth: '$10,000,000 COP', discount: '20 %', totalValue: '$8,000,000 COP', image: require('../img/SonyAlphaA7 III.jpg') },
