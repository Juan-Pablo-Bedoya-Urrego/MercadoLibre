...
const MyFavorites = () => {
    ...
    const favorites = () => {
        const favoritesList = [
            { id: '1', title: 'Apple iPhone 15 pro max',description:'Un sistema de cámaras avanzado con sensores.',status:'Disponible',image:require('../image/Auriculares.png')},
            ...
            { id: '3', title: 'Sony WH-1000XM5',description:'Son auriculares inalámbricos de gama alta. ',status:'Disponible',image:require('../image/iPhone.jpg')},
        ];
