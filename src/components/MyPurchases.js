...
const MyPurchases = () => {
    ...
    const buy = () => {
        const purchasesList = [
            { id: '1', title: 'Google Pixel 8',description:'Su cámara principal de 50 MP y imágenes avanzado.',status:'En tránsito', image:require('../image/GooglePixel8.jpg')},
            { id: '2', title: 'Sony A90J OLED',description:'Es un televisor de 65 pulgadas con panel OLED.',status:'Cancelado', image:require('../image/SonyA90JOLED.jpg')},
            { id: '3', title: 'Nikon Z9',description:'Una cámara sin espejo de formato completo.',status:'Entregado', image:require('../image/NikonZ9.jpg')},
 ];
